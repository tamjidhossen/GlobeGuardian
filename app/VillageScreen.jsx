...
export default function VillageScreen() {
  ...
  const handleNextMessage = () => {
    if (messageIndex < messages.length - 1) {
      ...
      navigation.navigate('VillageScreen1'); // Navigate to VillageScreen-1 after all messages are read
    }
  };

  const handleSkip = () => {
    setModalVisible(false); // Close the modal immediately when skip is pressed
    navigation.navigate('VillageScreen1'); // Navigate to VillageScreen-1 immediately when skipped
  };
